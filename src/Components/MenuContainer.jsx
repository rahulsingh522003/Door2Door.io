        ...
        <div className="w-full flex items-center justify-start lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none">

           {
               categories && categories.map(category => (
                <motion.div whileTap={{scale:0.75}} key = {category.id} className={
                    `group ${filter === category.urlParamName ? `bg-red-600` : `bg-white`} w-24 min-w-[94px] h-28 cursor-pointer hover:bg-red-600 rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center`
                }
