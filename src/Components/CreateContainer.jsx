  ...
  const uploadImage = (e) => {
    ...
    uploadTask.on('state_changed',
      ...
      (error) => {
        console.log(error);
        setFields(true);
        setMsg("Error while uploading : Try againg");
...

          {
            fields && (
              <motion.p
                ...
                className={`w-full p-2 rounded-lg text-center font-semibold ${alertStatus === "danger"
...
<div className="group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg">
            {isLoading ? <Loader /> : <>
              ...
              {!imageAsset ? <>
                ...
                <label className='w-full-h-full flex flex-col items-center justify-centerc cursor-pointer' >
                  <div className='w-full-h-full flex flex-col items-center justify-centerc cursor-pointer'>
                ...
                <>
                  <div className="relative h-full">
                    ...
                    <button className="absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-in-out"
                      onClick={deleteImage}
                    >
